...
export const filmsMocks = [
    {
        ...
        description: "Incorporating elements of documentary filmmaking and found footage, the film follows the events of a late-night talk show episode aired on the night of Halloween 1977, during which the host attempts to boost ratings by inviting an allegedly possessed girl onto the show.",
        imageUrl: img1,
    ...
    },
    {
        ...
        description: "Stopmotion is a horror movie about an animator (Aisling Franciosi) who tries to move out from under the shadow of her abusive mother, working on a new project with the help of a mysterious little girl. Its a gory, hallucinatory, almost experimental work thats unsettling but mesmerizing.",
        imageUrl: img2,
    ...
    },
    {
        ...
        year: "2022",
        starring: "Safia Oakley-Green, Kit Young, Chuku Modu, Iola Evans",
        description: "The premise is simple: this movie is “Alien in the stone age”. It begins with six intrepid early humans washing up on a Highlands beach, all of them quickly and efficiently sketched out as characters. Adem (Chuku Modu) is in charge and evidently sees himself as a mighty leader of men.",
        imageUrl: img3,
    ...
    },
    {
        ...
        description: "A young American woman is sent to Rome to begin a life of service to the church, but encounters a darkness that causes her to question her faith and uncovers a terrifying conspiracy that hopes to bring about the birth of evil incarnate. Create something to fear.",
        imageUrl: img4,
    ...
    },
    {
        ...
        description: "A lonely and troubled older man (Brendan Rock) lives alone in a mobile home. One late and stormy night he's visited by a barefooted young woman (Jordan Cowan) who asks for a ride into town. She claims she came from the beach, but it's unclear how she made it into the man's neighborhood.",
        imageUrl: img5,
    ...
    },
    {
        ...
        title: "SUMMONERS",
        year: "2022",
        starring: "Christine Nyland, McLean Peterson, Larry Fessenden, Madeline Grey DeFreece",
        description: "Jessica Whitman isn't a witch. Not anymore, at least. She left it behind when she left her hometown years ago. When a childhood friend needs her help performing a dark spell, she'll find herself questioning her sense of right and wrong.",
        imageUrl: img7,
    ...
    {
        id: 7,
        title: "MIDNIGHT PEEPSHOW",
        year: "2022",
        starring: "Derek Nelson, Chiara D'Anna, Bethan Walker, Jamie Bacon",
        description: "Synopsis In MIDNIGHT PEEPSHOW we are introduced to an unnamed Madame who owns and operates a peepshow offering patrons a tailor-made experience wrapped around their deepest desires, fears, and sins. Tonight, it welcomes a businessman who has a unique connection to an extreme fantasy website on the dark web.",
        imageUrl: img8,
    ...
    },
    {
        ...
        description: "Follows a woman as she readjusts to normalcy after a kidnapping. Her sense of reality begins to deteriorate when she travels to her husband's family compound.",
        imageUrl: img9,
    ...
    },
    {
        ...
        description: "Synopsis. A teenager is just trying to make it through life in the suburbs when his classmate introduces him to a mysterious late-night TV show—a vision of a supernatural world beneath their own. In the pale glow of the television, his view of reality begins to crack.",
        imageUrl: img10,
